  ...
  return (
    <div className="max-w-5xl mx-auto p-8 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="mb-2">
          Железобетонный свайно-ленточный фундамент (марка М250) высота в самой высокой точки от 40 см до 65 см от земли, сваи глубиной от 70 см до 100 см.
        </p>
        <p className="mb-2">
      ...
      <div className="mb-8">
        ...
        <p className="mb-2">Пенополистирол Толщ 150мм (Для утепления потолка 2-го этажа) – лист: 31</p>
