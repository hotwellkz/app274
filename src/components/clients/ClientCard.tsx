...
import { Building2, History, Eye, EyeOff } from 'lucide-react';
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-2 mb-1">
              ...
              <div className="text-right">
                ...
                <span className={`text-xs ml-1 ${netProfit >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                  ({formatPercent((netProfit / client.totalAmount) * 100)})
                </span>
              </div>
            </div>
